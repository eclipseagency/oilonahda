...
export const metadata: Metadata = {
  ...
  description: 'احجز جلسة مساج، حمام مغربي، بديكير، حمام زيت أو عناية بالبشرة في أويلو سبا بالرياض. اختر الخدمة، التاريخ والوقت المناسب لك.',
  alternates: { canonical: 'https://www.oilospa.com/booking' },
  openGraph: {
    title: 'حجز مساج وسبا في الرياض | Oilo Spa',
    description: 'احجز جلسة مساج أو حمام مغربي أو بديكير أو عناية بالبشرة في أويلو سبا بالرياض.',
